...
public class XmlSetGump : Gump
{
    ...
    public XmlSetGump(PropertyInfo prop, Mobile mobile, object o, Stack<StackEntry> stack, int page, List<object> list) : base(GumpOffsetX, GumpOffsetY)
    {
        m_Property = prop;
        m_Mobile = mobile;
        m_Object = o;
    ...
    private class InternalPicker : HuePicker
    {
        ...
        public InternalPicker(PropertyInfo prop, Mobile mobile, object o, Stack<StackEntry> stack, int page, List<object> list) : base(((IHued)o).HuedItemID)
        {
            m_Property = prop;
            m_Mobile = mobile;
            m_Object = o;
            ...
            case 1:
                {
                    ...
                    if (text != null)
                    {
                        try
                        {
                            toSet = XmlPropertiesGump.GetObjectFromString(m_Property.PropertyType, text);
                            shouldSet = true;
                        }
                        catch
                        {
