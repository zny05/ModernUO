...
public class XmlSpawnerSkillCheck
{
    ...
    public class RegisteredSkill
    {
        ...
        private static List<RegisteredSkill>[] m_MalasSkillList = new List<RegisteredSkill>[MaxSkills+1];
        private static List<RegisteredSkill>[] m_IlshenarSkillList = new List<RegisteredSkill>[MaxSkills+1];
        private static List<RegisteredSkill>[] m_TokunoSkillList = new List<RegisteredSkill>[MaxSkills+1];
        ...
        public static List<RegisteredSkill> TriggerList(SkillName index, Map map)
        {
            ...
            {
                return maplist[(int)index] ??= new List<RegisteredSkill>();
            }
            ...
            return maplist[MaxSkills] ??= new List<RegisteredSkill>();
        }
    }
    ...
    public static void CheckSkillUse(Mobile m, Skill skill, bool success)
    {
        ...
        List<XmlAttachment> list = XmlAttach.FindAttachments(m);
        ...
        */
        ...
        foreach(RegisteredSkill rs in skilllist)
        {
            if (rs.sid == skill.SkillName)
            {
                ...
                else if (rs.target is IXmlQuest quest)
                {
