...
public class XmlQuestPointsRewards
{
    ...
    private static List<XmlQuestPointsRewards> PointsRewardList = new();
    ...
    public static void Initialize()
    {
        ...
        PointsRewardList.Add(new XmlQuestPointsRewards(1000, typeof(PowerScroll), "105 Smithing powerscroll", 1000, 0x14F0,
            [SkillName.Blacksmith, 105]
       ));
        PointsRewardList.Add(new XmlQuestPointsRewards(2000, typeof(PowerScroll), "110 Smithing powerscroll", 2000, 0x14F0,
            [SkillName.Blacksmith, 110]
       ));
        PointsRewardList.Add(new XmlQuestPointsRewards(4000, typeof(PowerScroll), "115 Smithing powerscroll", 4000, 0x14F0,
            [SkillName.Blacksmith, 115]
       ));
        PointsRewardList.Add(new XmlQuestPointsRewards(500, typeof(AncientSmithyHammer), "+20 Ancient Smithy Hammer, 50 uses", 500, 0x13E4,
            [20, 50]
       ));
        PointsRewardList.Add(new XmlQuestPointsRewards(200, typeof(ColoredAnvil), "Colored Anvil", 400, 0xFAF, null));
        PointsRewardList.Add(new XmlQuestPointsRewards(100, typeof(PowderOfTemperament), "Powder Of Temperament, 10 uses", 300, 4102,
            [10]
       ));
        PointsRewardList.Add(new XmlQuestPointsRewards(100, typeof(LeatherGlovesOfMining), "+20 Leather Gloves Of Mining", 200, 0x13c6,
            [20]
       ));
