...
public class XmlAddGump : Gump
{
    ...
    private string NameListToString()
    {
        ...
        sb.AppendFormat($"{defs.NameList.Length}");
    ...
    private string SelectionListToString()
    {
        ...
        System.Text.StringBuilder sb = new System.Text.StringBuilder();
        sb.AppendFormat($"{defs.SelectionList.Length}");
    ...
    private class PlaceSpawnerTarget : Target
    {
        ...
        protected override void OnTarget(Mobile from, object targeted)
        {
            ...
            XmlSpawner spawner = new XmlSpawner(SpawnId, from.Location.X, from.Location.Y, 0, 0, sname, maxcount,
                ...
                defs.Team, defs.HomeRange, defs.HomeRangeIsRelative, [], defs.RefractMin, defs.RefractMax,
                ...
                defs.SequentialSpawn, null, defs.AllowGhostTrig, defs.AllowNPCTrig, defs.SpawnOnTrigger, null, defs.DespawnTime, defs.SkillTrigger, null)
            {
                PlayerCreated = true
            };
    ...
    public override void OnResponse(NetState state, in RelayInfo info)
    {
        ...
        {
            try { defaults.MinDelay = TimeSpan.FromMinutes(double.Parse(tr)); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        tr = info.GetTextEntry(101); // maxdelay info
        if (tr != null && tr.Length > 0)
        {
            try { defaults.MaxDelay = TimeSpan.FromMinutes(double.Parse(tr)); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.RefractMin = TimeSpan.FromMinutes(double.Parse(tr)); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.RefractMax = TimeSpan.FromMinutes(double.Parse(tr)); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.TODStart = TimeSpan.FromHours(double.Parse(tr)); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.TODEnd = TimeSpan.FromHours(double.Parse(tr)); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.HomeRange = int.Parse(tr); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.SpawnRange = int.Parse(tr); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.ProximityRange = int.Parse(tr); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.Team = int.Parse(tr); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.Duration = TimeSpan.FromMinutes(double.Parse(tr)); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.ProximitySound = int.Parse(tr); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.KillReset = int.Parse(tr); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.TriggerProbability = double.Parse(tr); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.DespawnTime = TimeSpan.FromHours(double.Parse(tr)); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
        ...
        if (tr != null && tr.Length > 0)
        {
            try { defaults.AutoNumberValue = int.Parse(tr); }
            catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
        }
            ...
            default:
                {
                    ...
                    if (info.ButtonID >= 5000 && info.ButtonID < 5000 + MaxEntries)
                    {
                        ...
                        else
                        {
                            ...
                            List<object> types = XmlPartialCategorizedAddGump.Match(defaults.NameList[i]);
