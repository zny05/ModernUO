...
public class XmlPartialCategorizedAddGump : Gump
{
    ...
    private readonly List<object> m_SearchResults;
    private readonly int m_Page;
    private readonly Gump m_Gump;
    private readonly int m_EntryIndex;
    private readonly XmlSpawner m_Spawner;

    public XmlPartialCategorizedAddGump(Mobile from, string searchString, int page, List<object> searchResults, bool explicitSearch, int entryindex, Gump gump) : base(50, 50)
    {
    ...
    private static void Match(string match, IReadOnlyList<Type> types, IList<object> results)
    {
        if (match.Length == 0)
        {
            return;
    ...
    public static List<object> Match(string match)
    {
    ...
    private class TypeNameComparer : IComparer<object>
    {
