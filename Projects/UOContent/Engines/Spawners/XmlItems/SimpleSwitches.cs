...
public class CombinationLock : Item
{
    ...
    public int CheckDigit(object o, string property)
    {
        ...
        if (argtest.Length > 1)
        {
            ...
            if (BaseXmlSpawner.CheckPropertyString(null, o, property, out _))
            {
                return 1; // true
            }
    ...
    public override void OnDoubleClick(Mobile from)
    {
        ...
        if (Matched)
        {
            ...
            BaseXmlSpawner.ApplyObjectStringProperties(null, m_TargetProperty, m_TargetItem, from, this, out _);
