...
public class XmlMagicWord : XmlAttachment
{
    ...
    private static string [] keywordlist = ["Shoda", "Malik", "Lepto" , "Velas", "Tarda", "Marda", "Vas Malik", "Nartor", "Santor"
    ];
    ...
    public override void OnTrigger(object activator, Mobile m)
    {
        ...
        switch (Word)
        {
            ...
            case "Tarda":
                {
                    m.AddSkillMod(new TimedSkillMod(SkillName.Tactics, "Tarda", true, 20, Duration));
                    m.SendMessage("You are more skillful warrior!");
                    break;
                }
            case "Marda":
                {
                    m.AddSkillMod(new TimedSkillMod(SkillName.Magery, "Marda", true, 20, Duration));
